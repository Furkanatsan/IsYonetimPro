...
namespace IsYonetimPro.Services.Abstract
{
    public interface ITaskService
    {
        ...
        Task<IResult> AddAsync(TaskAddDto taskAddDto,int createdById);//veri eklediğimizde  geriye taskDto dönmüş olacagız.bu sayede eklediğimiz verinin son hali elimizde olucak ve bunuda tablomuza ve toastera eklemek için kullanacagız.
