...
namespace IsYonetimPro.Services.Abstract
{
    public interface IEmployeeService
    {
        ...
        Task<IResult> AddAsync(EmployeeAddDto employeeAddDto, int createdById);//veri eklediğimizde  geriye employeeDto dönmüş olacagız.bu sayede eklediğimiz verinin son hali elimizde olucak ve bunuda tablomuza ve toastera eklemek için kullanacagız.
