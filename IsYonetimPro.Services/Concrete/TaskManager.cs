...
namespace IsYonetimPro.Services.Concrete
{
    public class TaskManager : ITaskService
    {
        ...
        public async Task<IResult> AddAsync(TaskAddDto taskAddDto, int createdById)
        {
            ...
            await _unitOfWork.Task.AddAsync(taskk);
            await _unitOfWork.SaveAsync();
            return new Result(ResultStatus.Success, $"{taskAddDto.TaskTitle} adlı iş eklenmiştir.");
        }
